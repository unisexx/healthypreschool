<?php if(@$_GET['export_type']!=''):?>
    ...
    <style>
    	@media print {
			...
			ul.breadcrumb,form,.btn,.add-on,.input-prepend,.hdtitle,h1:first-of-type{display: none !important;}
...
<?
	...
	$title_graph = "รายงานจำนวนและร้อยละของศูนย์เด็กเล็ก แจกแจงข้อมูลรายงานแบบคัดกรองโรค<br>".@$filter;
?>


<h1 style="text-align: center;"><?=$title_graph;?></h1>
