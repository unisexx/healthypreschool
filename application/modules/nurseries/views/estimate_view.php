...
<!-- <form method="post" action="nurseries/save_status/<?=$nursery->id?>" enctype="multipart/form-data"> -->
	...
	<fieldset style="border:1px dashed #ccc; padding:10px;">
			...
			<tr>
				...
				<td><?=get_assessment_approve_type_2($estimate->status,$estimate->approve_type,$estimate->approve_user_id,$estimate->total,$estimate->id,'nurseries/estimate_view/'.$nursery->id.'/'.$estimate->id)?></td>
				<td>
					<?
