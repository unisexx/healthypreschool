...
class Calendars extends Public_Controller
{
	...
	function index($id=FALSE)
	{
		...
		// }
		$this->template->title('ปฎิทินกิจกรรม');
		$this->template->build('calendar_index',$data);
	}
	
	function view($id,$group_id=FALSE)
	{
		$type = array("e-blue" => "ประชุม","e-red" => "สัมนา","e-green" => "อบรม","e-violet" => "อื่นๆ");
	...
	{
		$prefs['template'] = '
   		{table_open}<table class="table-calendar table table-condensed">{/table_open}
