...
<ul class="breadcrumb">
  ...
  <li class="active">ลงทะเบียนเจ้าหน้าที่ศูนย์</li>
</ul>
    <div id="data">
    	<div style="font-size:14px; font-weight:700; padding-bottom:10px; color:#3C3">ค้นหาข้อมูลศูนย์เด็กเล็กของคุณ</div>
    	
    	<form method="get" action="users/register_center">
