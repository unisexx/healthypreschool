...
<ul class="breadcrumb">
  ...
  <li class="active"><?=get_nursery_name($nursery_id)?> / แบบคัดกรองโรค</li>
</ul>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<a href="diseases/form_guest?nursery_id=<?=$row->nursery_id?>&classroom_id=<?=$row->classroom_id?>&month=<?=$row->month?>&year=<?=$row->year?>" class="btn btn-mini">ดูแบบคัดกรองโรค</a>
		</td>
	</tr>
	<? endforeach;?>
</table>
