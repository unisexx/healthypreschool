...
$(document).ready(function(){
	...
	$(".openmodal").live("click",function(){
		...
		$.get('diseases/get_disease_form',{
			'nursery_name'			: $('td.nursery_name').text(),
			'school_year'				: $('td.school_year').text(),
			'classroom_name' 		: $("td.room_name").text(),
	...
	$("#frmdiseasetable").validate({
		...
		messages:
		{
			month:
			{
				required: "กรุณาเลือกเดือนที่ต้องการบันทึกข้อมูล"
			},
			year:
			{
				required: "กรุณาเลือกปีที่ต้องการบันทึกข้อมูล"
			}
		}
	});
});
...
<form id="frmdiseasetable" method="get" action="diseases/form3">
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#F5F5F5" class="table2">
  <tr>
    ...
    <td width="56%" class="nursery_name"><?=user_login()->nursery->name?></td>
  </tr>
  <tr>
  	<td align="right">ปีการศึกษา</td>
  	<td class="school_year"><?=@$_GET['school_year']?></td>
  </tr>
  <tr>
    <td align="right">ห้องเรียน / ชั้นเรียน</td>
    <td class="room_name">
...
<?if($_GET['classroom_id']):?>
  <tr>
  	...
  	<td>
    	<select name="month" id="room3" style="margin-bottom:5px;">
        ...
        <?endfor;?>
		  ...
		  พ.ศ. <select name="year" id="room2" style="margin-bottom:5px;">
...
<?endif;?>  
	<tr>
		...
		<td>
			...
			<input type="hidden" name="school_year" value="<?=$_GET['school_year']?>">
...
<div class="outer">
  <div class="inner">
		...
		<table class="table3">
		  ...
		  <thead>
			  <tr bgcolor="#cce5fe">
			    <th rowspan="2" align="center" class="span1"><b>ลำดับ</b></th>
			    <th rowspan="2" align="center"  class="span4"><b>ชื่อ - สกุล เด็ก</b></th>
			  </tr>
			  <tr bgcolor="#cce5fe">
