<style type="text/css">
.aviaslider{ 
height:155px; 	/*this changes the height of the image slider*/
width:580px;
...
<ul class='aviaslider' id="direction-fade-slider">
	<?php foreach($hilights as $hilight):?>
		<li><a href="<?php echo $hilight->url?>" title=""><img src="uploads/hilight/<?php echo $hilight->image?>" alt="<?php echo lang_decode($hilight->title)?>" width="580"/></a></li>
	<?php endforeach;?>
</ul>