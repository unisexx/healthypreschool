...
<script type="text/javascript">
	$(document).ready(function(){
		$("table.table tr:not(:first)").each(function(){
			var btn = "<span style='float:right;'><input class='check btn btn-mini' type='button' value='เลือกทั้งหมด'> <input class='uncheck btn btn-mini' type='button' value='ไม่เลือกทั้งหมด'></span>";
